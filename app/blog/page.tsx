...
export const metadata: Metadata = {
    title: 'Blog de Marketing y Branding',
    description: 'Leé artículos de Gaia Studio sobre branding, marketing digital, SEO y diseño web para marcas que quieren crecer con una estrategia clara.',
    openGraph: {
        title: 'Blog de Marketing y Branding | Gaia Studio',
        description: 'Leé artículos de Gaia Studio sobre branding, marketing digital, SEO y diseño web para marcas que quieren crecer con una estrategia clara.',
